...
def demo():
    ...
    while True:
        if p.is_connected():
            ...
            if not button_pin_audio.value():
                print("Audio Button pressed!")
                p.send("a")
                while not button_pin_audio.value():
                    utime.sleep_ms(10)  # Debouncing delay
            
            if not button_pin_video.value():
                print("Video Button pressed!")
                p.send("v")
                while not button_pin_video.value():
                    utime.sleep_ms(10)  #
